<template>
  <q-card
    ...
    flat
    class="q-ma-md"
    :class="[this.order.accepted == 'Yes' ? 'selected' : 'zz']"
  ...
  >
    ...
    <div
      ...
      v-if="this.order.accepted == 'Yes' || this.order.accepted == 'No'"
    >
      <q-badge
      ...
      <q-badge class="bg-red text-white" v-if="this.order.accepted == 'No'">
